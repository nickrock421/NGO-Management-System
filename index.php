...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Peppy Happy | Home Page</title>
    ...
    <body>
          ...
          <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
            ...
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="index.php">Volunteer Login</a>
        ...
        <h4 class="font-weight-bold text-center text-danger">Welcome to Peppy Happy</h4>
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title text-danger" style="font-size:20px;">Volunteer Login</span>
